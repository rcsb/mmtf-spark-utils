...
public class SequenceSimFilter implements Function<Tuple2<Integer, Integer>, Boolean> {
	...
	public SequenceSimFilter(double minSeqIdInput, Broadcast<List<Tuple2<String,CalphaAlignBean>>> inputData) {
