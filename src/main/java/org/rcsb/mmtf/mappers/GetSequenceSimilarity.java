...
public class GetSequenceSimilarity implements PairFunction<Tuple2<Integer,Integer>,String,Float> {
	...
	public GetSequenceSimilarity(Broadcast<List<Tuple2<String,CalphaAlignBean>>> inputData) {
	...
	public Tuple2<String, Float> call(Tuple2<Integer, Integer> inputTuple) throws Exception {
		...
		PairwiseSequenceAligner<ProteinSequence, AminoAcidCompound> smithWaterman = Alignments.getPairwiseAligner(ps1, ps2, PairwiseSequenceAlignerType.GLOBAL, penalty, matrix);
		...
		return new Tuple2<String, Float>(data.get(inputTuple._1)._1+"__"+data.get(inputTuple._2)._1, (float) smithWaterman.getSimilarity());
	}
