...
public class ObjectToByteArr implements PairFunction<Tuple2<String, CalphaDistBean>, String, byte[]>{
	...
	@Override
	public Tuple2<String, byte[]> call(Tuple2<String, CalphaDistBean> t) throws Exception {
